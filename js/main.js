...
function renderNavbar() {
  ...
  nav.innerHTML = `
    ...
    <nav class="navbar" role="navigation">
      <div class="container navbar__inner">
        ...
        <div class="navbar__links">
          <a href="${basePath}index.html" class="navbar__link" data-i18n="nav_home">Beranda</a>
          <a href="${basePath}catalog.html" class="navbar__link" data-i18n="nav_catalog">Belanja</a>
          <a href="${basePath}about.html" class="navbar__link" data-i18n="nav_about">Tentang Kami</a>
          <a href="${basePath}blog.html" class="navbar__link" data-i18n="nav_blog">Blog</a>
        ...
        <div class="navbar__actions">
          ...
          <!-- Not logged in -->
          <a href="${basePath}login.html" id="navbar-login-btn" class="btn btn--secondary btn--sm" data-i18n="nav_login">Masuk</a>
          ...
          <div class="navbar__user" id="navbar-user-menu" style="display:none;">
            ...
            <div class="navbar__dropdown">
              ...
              <a href="${basePath}admin/index.html" class="navbar__dropdown-item" id="navbar-admin-link" style="display:none;" data-i18n="nav_admin">Panel Admin</a>
    ...
    <div class="navbar__mobile" id="navbar-mobile">
      <a href="${basePath}index.html" class="navbar__mobile-link" data-i18n="nav_home">Beranda</a>
      <a href="${basePath}catalog.html" class="navbar__mobile-link" data-i18n="nav_catalog">Belanja</a>
      <a href="${basePath}about.html" class="navbar__mobile-link" data-i18n="nav_about">Tentang Kami</a>
      <a href="${basePath}blog.html" class="navbar__mobile-link" data-i18n="nav_blog">Blog</a>
      <a href="${basePath}contact.html" class="navbar__mobile-link" data-i18n="nav_contact">Kontak</a>
      <a href="${basePath}testimonials.html" class="navbar__mobile-link">Ulasan Pelanggan</a>
      <div style="margin-top: auto; padding-top: 1rem; border-top: 1px solid var(--color-border-light);">
        <a href="${basePath}login.html" class="btn btn--primary btn--full" data-i18n="nav_login">Masuk</a>
      </div>
    </div>
  `;
}
        ...
        <div class="footer__grid">
          ...
          <div>
            ...
            <ul class="footer__links">
              <li><a href="${basePath}catalog.html" class="footer__link" data-i18n="cat_home_decor">Dekorasi Rumah</a></li>
              <li><a href="${basePath}catalog.html?cat=daily-needs" class="footer__link" data-i18n="cat_daily_needs">Kebutuhan Harian</a></li>
              <li><a href="${basePath}catalog.html?cat=kitchen" class="footer__link" data-i18n="cat_kitchen">Dapur & Makan</a></li>
              <li><a href="${basePath}catalog.html?cat=bedroom" class="footer__link" data-i18n="cat_bedroom">Kamar & Ruang Tamu</a></li>
              <li><a href="${basePath}catalog.html?cat=bath" class="footer__link" data-i18n="cat_bath">Mandi & Perawatan</a></li>
            </ul>
          </div>
          <div>
            <h4 class="footer__col-title">Info</h4>
            <ul class="footer__links">
              <li><a href="${basePath}about.html" class="footer__link" data-i18n="nav_about">Tentang Kami</a></li>
              <li><a href="${basePath}blog.html" class="footer__link" data-i18n="nav_blog">Blog</a></li>
              <li><a href="${basePath}testimonials.html" class="footer__link" data-i18n="testimonials_title">Ulasan</a></li>
              <li><a href="${basePath}contact.html" class="footer__link" data-i18n="nav_contact">Kontak</a></li>
            </ul>
          </div>
          <div>
